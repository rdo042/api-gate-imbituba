...
{
    /// <summary>
    /// Validador FluentValidation para CriarMotoristaCommand
    /// </summary>
    public class CriarMotoristaCommandValidator : AbstractValidator<CriarMotoristaCommand>
    {
        public CriarMotoristaCommandValidator()
        {
            RuleFor(x => x.Nome)
                .NotEmpty()
